...
torchrun --standalone --nproc_per_node=1 -m scripts.base_train -- --depth=20 --window-pattern=L --target-param-data-ratio=8.25 --device-batch-size=16 --fp8 --run=$WANDB_RUN
